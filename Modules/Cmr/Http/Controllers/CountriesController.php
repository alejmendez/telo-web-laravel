...
namespace Modules\Cmr\Http\Controllers;

use Inertia\Inertia;
use Modules\Core\Http\Controllers\Controller;
use Modules\Core\Traits\HasPermissionMiddleware;
use Modules\Cmr\Http\Requests\StoreCountryRequest;
use Modules\Cmr\Http\Requests\UpdateCountryRequest;
use Modules\Cmr\Http\Resources\CountryResource;
use Modules\Cmr\Services\CountryService;
...
class CountriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Cmr::Countries/List', [
            'toast' => session('toast'),
        ]);
    }
    ...
    {
        return Inertia::render('Cmr::Countries/Create');
    }
    ...
    public function show(int $id)
    {
        ...
        return Inertia::render('Cmr::Countries/Show', [
    ...
    public function edit(int $id)
    {
        ...
        return Inertia::render('Cmr::Countries/Edit', [
            'data' => new CountryResource($country),
        ]);
    }
